package com.tapioca.design.patterns.iterator.array;
...
/**
 * Array-backed Properties - store all the fields in a single array
 * if they're not addressable directly.
 */
...
public class ArrayBackedPropsDemo {
