package com.tapioca.design.patterns.state.spring;
 ...
 */
enum States { // Plural because SSM defines a class called State already
    OFF_HOOK, // Starting
    ON_HOOK, // Terminal
    CONNECTING,
    CONNECTED,
...
public class SpringStateMachineDemo {
    ...
    // This requires the Spring framework dependencies
