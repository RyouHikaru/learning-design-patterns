package com.tapioca.design.patterns.visitor.classic;

/**
 * Classic Visitor (Double Dispatch)
 * Note: One of the downside of this approach is the tight coupling
 * between the expression and the visitors.
 */
