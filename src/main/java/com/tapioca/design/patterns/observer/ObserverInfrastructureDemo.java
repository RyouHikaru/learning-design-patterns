package com.tapioca.design.patterns.observer;

import java.util.ArrayList;
import java.util.List;

/**
 * Observer - an object that wishes to be informed about events
 * happening in the system. The entity generating the events
 * is an observable.
 */
...
public class ObserverInfrastructureDemo implements Observer<Person> { // Observer<Foo>
