package com.tapioca.design.patterns.nullobject;

/**
 * Null Object - a no-op object that conforms to the required
 * interface, satisfying a dependency requirement of some
 * other object.
 */
interface Log {
