package com.tapioca.design.patterns.decorator.string;
...
/**
 * Decorator - facilitates the addition of behaviors to
 * individual objects without inheriting them.
 */
class MagicString {
    ...
    // Delegated methods from String class
    public int length() {
...
public class Decorator {
    public static void main(String[] args) {
        MagicString s = new MagicString("Dude");
